import s1 from "../assets/speakers/speaker1.jpg"
import s2 from "../assets/speakers/speaker2.jpg"
import s3 from "../assets/speakers/speaker3.jpg"
import s4 from "../assets/speakers/speaker4.jpg"

import ntDavis from "../assets/logos/presented-neurotech-davis.png"
import ntBerkeley from "../assets/logos/presented-neurotech-berkeley.png"
...
import sponsorCeribell from "../assets/logos/sponsor-ceribell.png"
...
export const presentedByLogos = [ // no size -> defaults to 23px
  { src: ntDavis, size: "h-14" },
  { src: ntBerkeley, size: "h-24" },
  { src: crux, size: "h-20" },
  { src: triton },
  { src: ntUsc, size: "h-18" },
]
